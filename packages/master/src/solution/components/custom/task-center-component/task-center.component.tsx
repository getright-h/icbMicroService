...
import { Button, Empty, Popover, Progress, Tabs } from 'antd';
...
export default function TaskCenterComponent() {
  const { state, indexRef, refreshDownloadTasks, downloadFile, loadMore, showTaskCenterChange } = useTaskCenterStore();
