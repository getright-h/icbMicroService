declare namespace RoleManageComponentLessNamespace {
...
declare const RoleManageComponentLessModule: RoleManageComponentLessNamespace.IRoleManageComponentLess & {
  /** WARNING: Only available when `css-loader` is used without `style-loader` or `mini-css-extract-plugin` */
  locals: RoleManageComponentLessNamespace.IRoleManageComponentLess;
};

export = RoleManageComponentLessModule;
