declare namespace TablePageTelComponentLessNamespace {
...
declare const TablePageTelComponentLessModule: TablePageTelComponentLessNamespace.ITablePageTelComponentLess & {
  /** WARNING: Only available when `css-loader` is used without `style-loader` or `mini-css-extract-plugin` */
  locals: TablePageTelComponentLessNamespace.ITablePageTelComponentLess;
};

export = TablePageTelComponentLessModule;
