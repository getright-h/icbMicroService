import { WarehouseManageDTO, ExampleRequestParam, ExampleResponseResult } from '../dto/warehouse-manage.dto';
...
@DepUtil.Injectable()
export class WarehouseManageService extends WarehouseManageDTO {
