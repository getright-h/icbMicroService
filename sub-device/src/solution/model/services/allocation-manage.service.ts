import { AllocationManageDTO, ExampleRequestParam, ExampleResponseResult } from '../dto/allocation-manage.dto';
...
@DepUtil.Injectable()
export class AllocationManageService extends AllocationManageDTO {
